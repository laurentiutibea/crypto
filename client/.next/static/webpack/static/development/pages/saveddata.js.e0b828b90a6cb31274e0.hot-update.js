...
function (_Component) {
  ...
  function SavedData() {
    ...
    _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_6___default.a.mark(function _callee() {
      var _graphs, _ref2, data, bkOptions, i, _graphs$push;
          ...
          switch (_context.prev = _context.next) {
            case 0:
              if (_this.state.graphs.length === 0) {
                ...
                _graphs = Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_8__["default"])(_this.state.graphs);
              }
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_16__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_14__["default"])(_this), "compare", function (e, index) {
      if (e.target.checked) {
        ...
        var _graphs2 = Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_8__["default"])(_this.state.graphs);

        console.log(_graphs2[index]);
        ...
        worker.postMessage("".concat(_graphs2[index].cryptocurrency.value, ",").concat(_graphs2[index].currency.value, ",").concat(_this.state.jwt));
...
//# sourceMappingURL=saveddata.js.e0b828b90a6cb31274e0.hot-update.js.map