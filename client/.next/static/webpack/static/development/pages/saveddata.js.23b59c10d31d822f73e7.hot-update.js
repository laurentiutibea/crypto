...
function (_Component) {
  ...
  function SavedData() {
    ...
    _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_7___default.a.mark(function _callee() {
      var graphs, _ref2, data, i, bkOptions, _j;
          ...
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              for (i = 0; i < data.graphs.length; i++) {
                ...
                if (data.graphs[i].series.length > 0) {
                  for (_j = 0; _j < data.graphs[i].series.length; _j++) {
                    bkOptions.series.push({
                      type: "line",
                      name: "".concat(data.graphs[i].cryptocurrency.name, " to ").concat(data.graphs[i].currency.name),
                      data: data.graphs[i].series[_j].data
                    });
                  }
                } else {
                  bkOptions.series = [{
              ...
              case 0:
                ...
                graphs.forEach(function (element) {
                  bkGraphs.push({
                    ...
                    series: action === "save" ? element.chartOptions.series : element.chartOptions.series[1],
...
//# sourceMappingURL=saveddata.js.23b59c10d31d822f73e7.hot-update.js.map