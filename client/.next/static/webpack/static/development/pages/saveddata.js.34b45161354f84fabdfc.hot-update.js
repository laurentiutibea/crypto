            ...
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                for (i = 0; i < data.graphs.length; i++) {
                  bkOptions.title = {
                    text: "".concat(data.graphs[i].cryptocurrency.name, " to ").concat(data.graphs[i].ocurrency.name, " exchange rate over time")
                  }, bkOptions.series = [{
                    type: "line",
...
//# sourceMappingURL=saveddata.js.34b45161354f84fabdfc.hot-update.js.map