...
function (_Component) {
  ...
  function CustomData() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_16__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_14__["default"])(_this), "changeGraphLive", function (e, index) {
      if (e.target.checked) {
        var _interval = Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_9__["default"])(_this.state.interval);

        var runningInterval = setInterval(function () {
          return _this.liveData(index);
        }, 4000);

        _interval.push(runningInterval);
...
//# sourceMappingURL=customdata.js.e3192bd858bc6f1de007.hot-update.js.map