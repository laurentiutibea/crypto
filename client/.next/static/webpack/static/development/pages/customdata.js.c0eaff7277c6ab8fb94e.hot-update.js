...
function (_Component) {
  ...
  function CustomData() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_16__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_14__["default"])(_this), "refreshSingle", function () {
      var worker = new Worker("static/service-worker.js");
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_11__["default"])(CustomData, [{
    ...
    value: function render() {
      ...
      return __jsx(_components_layout__WEBPACK_IMPORTED_MODULE_18__["default"], {
        ...
        __self: this
      }, "REFRESH"), this.state.graphs.length > 0 ? this.state.graphs.map(function (item, index) {
        return __jsx("div", {
          className: "row mt-4",
          key: item.id,
          __source: {
          ...
          className: "btn btn-primary",
          onClick: _this2.refreshSingle,
          __source: {
            fileName: _jsxFileName,
            lineNumber: 222
          },
          __self: this
        }, "REFRESH THIS"), __jsx("button", {
          className: "btn btn-primary",
          onClick: _this2.addGraph,
          __source: {
            fileName: _jsxFileName,
            lineNumber: 223
          },
...
//# sourceMappingURL=customdata.js.c0eaff7277c6ab8fb94e.hot-update.js.map