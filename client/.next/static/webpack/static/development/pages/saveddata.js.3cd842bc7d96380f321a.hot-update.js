            ...
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                for (i = 0; i < data.graphs.length; i++) {
                  bkOptions.title = {
                    text: "".concat(data.graphs[i].cryptocurrency.name, " to ").concat(this.state.selectedCurrency.name, " exchange rate over time")
                  }, bkOptions.series = [{
                    type: "line",
...
//# sourceMappingURL=saveddata.js.3cd842bc7d96380f321a.hot-update.js.map