            ...
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                for (i = 0; i < data.graphs.length; i++) {
                  bkOptions.title = {
                    text: "".concat(data.graphs[i].cryptocurrency.name, " to ").concat(data.graphs[i].cryptocurrency.name, " exchange rate over time")
                  }, bkOptions.series = [{
                    type: "line",
...
//# sourceMappingURL=saveddata.js.fb8ec87999335c2d2cc3.hot-update.js.map