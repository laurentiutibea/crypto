              ...
              case 4:
                ...
                for (i = 0; i < data.graphs.length; i++) {
                  bkOptions.title = {
                    ...
                    type: "line",
                    name: "".concat(data.graphs[i].cryptocurrency.name, " to ").concat(this.state.selectedCurrency.name),
                    data: e.data.prices
                  }];
...
//# sourceMappingURL=saveddata.js.8e90cef09541b9d724c0.hot-update.js.map