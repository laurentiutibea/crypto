  ...
  function CustomData() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_16__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_14__["default"])(_this), "getFilteredCurrency", function () {
      var _this$state2 = _this.state,
          searchQueryCryptocurrency = _this$state2.searchQueryCryptocurrency,
          allData = _this$state2.cryptocurrencies;
      var data = allData;
      if (searchQueryCryptocurrency) data = allData.filter(function (m) {
        return m.name.toLowerCase().startsWith(searchQuery.toLowerCase());
      });
...
//# sourceMappingURL=customdata.js.997e94dfd10af9b05b0e.hot-update.js.map