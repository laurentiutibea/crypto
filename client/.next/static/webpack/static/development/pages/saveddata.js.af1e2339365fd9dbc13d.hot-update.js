            ...
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                for (i = 0; i < data.graphs.length; i++) {
                  bkOptions.title = {
                    text: "".concat(this.state.selectedCryptocurrency.name, " to ").concat(this.state.selectedCurrency.name, " exchange rate over time")
                  }, bkOptions.series = [{
                    type: "line",
                    name: "".concat(this.state.selectedCryptocurrency.name, " to ").concat(this.state.selectedCurrency.name),
                    data: e.data.prices
                  }];
                  bkOptions.xAxis.categories = Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_8__["default"])(e.data.time);
                  graphs.push({
...
//# sourceMappingURL=saveddata.js.af1e2339365fd9dbc13d.hot-update.js.map