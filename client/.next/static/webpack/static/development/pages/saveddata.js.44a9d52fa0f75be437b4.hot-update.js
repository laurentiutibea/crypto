            ...
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                for (i = 0; i < data.graphs.length; i++) {
                  bkOptions.title = {
                    text: "".concat(data.graphs[i].name, " to ").concat(this.state.selectedCurrency.name, " exchange rate over time")
                  }, bkOptions.series = [{
                    type: "line",
...
//# sourceMappingURL=saveddata.js.44a9d52fa0f75be437b4.hot-update.js.map