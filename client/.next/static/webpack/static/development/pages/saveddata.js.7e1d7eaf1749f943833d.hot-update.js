  ...
  function SavedData() {
    ...
    function () {
      ...
      _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_6___default.a.mark(function _callee3(e, index) {
        var worker, _graphs, _loadArr, _graphs2, _loadArr2;
            ...
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                worker.onmessage = function (e) {
                  _graphs[index].chartOptions.series.push({
                    type: "line",
                  ...
                  for (var i = 0; i < e.data.time.length; i++) {
                    dates.push(_graphs[index].chartOptions.xAxis.categories[i]);
                    dates.push(e.data.time[i]);
                  }

                  _graphs[index].chartOptions.xAxis.categories = [].concat(dates);
                  _graphs[index].chartOptions.series[0].pointInterval = 2;
                  ...
                  console.log(_graphs[index].chartOptions.xAxis.categories);
                };

                worker.postMessage("".concat(_graphs[index].cryptocurrency.value, ",").concat(_graphs[index].currency.value, ",").concat(_this.state.jwt));
                _context3.next = 21;
                break;

              case 11:
                _graphs2 = Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_7__["default"])(_this.state.graphs);
                _loadArr2 = Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_7__["default"])(_this.state.loadArr);
                _loadArr2[index] = true;
                _context3.next = 16;
              ...
              case 16:
                _graphs2[index].chartOptions.title = {
                  text: "".concat(_graphs2[index].cryptocurrency.name, " to ").concat(_graphs2[index].currency.name, " exchange rate over time")
                };
                _graphs2[index].chartOptions.series = [{
                  type: "line",
                  name: "".concat(_graphs2[index].cryptocurrency.name, " to ").concat(_graphs2[index].currency.name),
                  data: _graphs2[index].chartOptions.series[0].data,
                  connectNulls: true
                }];
                if (_graphs2[index].chartOptions.xAxis.categories.length > 9) _graphs2[index].chartOptions.xAxis.categories = _graphs2[index].chartOptions.xAxis.categories.filter(function (item, index) {
                  return index % 2 === 0;
                });
                _loadArr2[index] = false;
...
//# sourceMappingURL=saveddata.js.7e1d7eaf1749f943833d.hot-update.js.map