            ...
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                for (i = 0; i < data.graphs.length; i++) {
                  bkOptions.title = {
                    text: "".concat(data.graphs[i].crypto, " to ").concat(this.state.selectedCurrency.name, " exchange rate over time")
                  }, bkOptions.series = [{
                    type: "line",
...
//# sourceMappingURL=saveddata.js.f5acab5edc139aeae30b.hot-update.js.map