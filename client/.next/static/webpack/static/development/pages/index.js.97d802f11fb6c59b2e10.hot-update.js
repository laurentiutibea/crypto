...
function (_Component) {
  ...
  function Index() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "handleReq", function () {
      fetch("http://localhost:3900/api/crypto").then(function (res) {
        return res.json();
      }).then(function (res) {
        return console.log("RESULT:::");
      });
      var socket = socket_io_client__WEBPACK_IMPORTED_MODULE_11___default()("http://localhost:3900/api/crypto");
...
//# sourceMappingURL=index.js.97d802f11fb6c59b2e10.hot-update.js.map