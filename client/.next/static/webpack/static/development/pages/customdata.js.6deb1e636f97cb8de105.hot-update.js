...
function (_Component) {
  ...
  function CustomData() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_16__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_14__["default"])(_this), "getFilteredCryptocurrency", function () {
      var searchQueryCryptocurrency = _this.state.searchQueryCryptocurrency;
      var data = allData;
      if (searchQuery) data = allData.filter(function (m) {
        return m.name.toLowerCase().startsWith(searchQuery.toLowerCase());
      });else if (searchQuery2) data = allData.filter(function (m) {
        return m.name.toLowerCase().startsWith(searchQuery.toLowerCase());
      });
      return {
        data: data
...
//# sourceMappingURL=customdata.js.6deb1e636f97cb8de105.hot-update.js.map