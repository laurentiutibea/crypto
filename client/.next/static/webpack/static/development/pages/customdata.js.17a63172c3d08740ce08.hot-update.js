  ...
  function CustomData() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_16__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_14__["default"])(_this), "refreshSingle", function (index) {
      ...
      worker.onmessage = function (e) {
        ...
        var cryptocurrency = graphs[index].cryptocurrency;
        var currency = graphs[index].currency;
        graphs[index].chartOptions.series = [{
          type: "line",
          name: "".concat(cryptocurrency, " to ").concat(currency),
          data: e.data.prices
        }];
        graphs[index].chartOptions.series[0].name = "".concat(cryptocurrency, " to ").concat(currency);
...
//# sourceMappingURL=customdata.js.17a63172c3d08740ce08.hot-update.js.map