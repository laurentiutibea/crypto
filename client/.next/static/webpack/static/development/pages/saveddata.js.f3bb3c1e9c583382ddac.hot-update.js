          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 5:
                ...
                graphs[index].chartOptions.xAxis.categories = graphs[index].chartOptions.xAxis.categories.filter(function (item, index) {
                  return index % 2 === 0;
                });
                loadArr[index] = false;
              ...
              case 0:
                ...
                graphs.forEach(function (element, i) {
                  if (i === index) bkCategories = element.chartOptions.xAxis.categories.filter(function (item, index) {
                    return index % 2 !== 0;
                  });else if (element.chartOptions.xAxis.categories.length > 0) bkCategories = element.chartOptions.xAxis.categories.filter(function (item, index) {
                    return index % 2 !== 0;
                  });
                  bkGraphs.push({
                    categories: action === "save" ? i === index ? bkCategories : element.chartOptions.xAxis.categories : element.chartOptions.xAxis.categories,
...
//# sourceMappingURL=saveddata.js.f3bb3c1e9c583382ddac.hot-update.js.map