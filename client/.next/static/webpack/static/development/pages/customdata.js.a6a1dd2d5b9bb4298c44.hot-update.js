...
function (_Component) {
  ...
  function CustomData() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_16__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_14__["default"])(_this), "refreshSingle", function (index) {
      ...
      worker.onmessage = function (e) {
        var cryptocurrency = _this.findName(_this.state.cryptocurrencies, graphs[index].cryptocurrency);

        var currency = _this.findName(_this.state.cryptocurrencies, graphs[index].cryptocurrency);

        graphs[index].chartOptions.title = {
          text: "".concat(graphs[index].cryptocurrency, " to ").concat(graphs[index].currency, " exchange rate over time")
...
//# sourceMappingURL=customdata.js.a6a1dd2d5b9bb4298c44.hot-update.js.map