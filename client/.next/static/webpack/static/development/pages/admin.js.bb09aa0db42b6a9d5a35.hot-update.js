...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_10__["default"])(Admin, [{
    ...
    value: function render() {
      if ( true && !_services_authService__WEBPACK_IMPORTED_MODULE_19__["default"].getCurrentUser() && !this.state.user.isAdmin) {
        window.location.replace("/login");
      } else {
        //if(process.browser && !this.state.user.isAdmin) window.location.replace("/index");
...
//# sourceMappingURL=admin.js.bb09aa0db42b6a9d5a35.hot-update.js.map