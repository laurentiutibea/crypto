...
function (_Component) {
  ...
  function CustomData() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_16__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_14__["default"])(_this), "findName", changeCryptocurrency = function changeCryptocurrency(e, array) {
      console.log(e.target.value);
      var name = "";

      for (var i = 0; i < _this.state[array].length; i++) {
        if (_this.state[array][i].id === e.target.value) {
          name = _this.state[array][i].name;
          break;
        }
      }
...
//# sourceMappingURL=customdata.js.e004cb5b1730be48cc44.hot-update.js.map