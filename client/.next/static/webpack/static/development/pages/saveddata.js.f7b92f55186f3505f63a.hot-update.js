    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_15__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_13__["default"])(_this), "compare", function (e, index) {
      if (e.target.checked) {
        ...
        worker.onmessage = function (e) {
          ...
          loadArr[index] = false;
          _this.state.graphs[index] = _this.setState({
            loadArr: loadArr,
            compare: true
          });
          console.log(graphs);
            ...
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                graphs.forEach(function (element, i) {
                  console.log(element.chartOptions.xAxis.categories);

                  if (i === index) {
                    bkCategories = element.chartOptions.xAxis.categories.filter(function (item) {
                      return item % 2 === 0;
                    });
...
//# sourceMappingURL=saveddata.js.f7b92f55186f3505f63a.hot-update.js.map