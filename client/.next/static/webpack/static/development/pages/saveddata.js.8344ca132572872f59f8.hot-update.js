...
function (_Component) {
  ...
  function SavedData() {
    ...
    _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_7___default.a.mark(function _callee() {
      var graphs, _ref2, data, i, bkOptions, j;
          ...
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              for (i = 0; i < data.graphs.length; i++) {
                ...
                if (typeof data.graphs[i].series === "array") {
                  for (j = 0; j < data.graphs[i].series.length; j++) {
                    bkOptions.series.push({
                      type: "line",
                      name: "".concat(data.graphs[i].cryptocurrency.name, " to ").concat(data.graphs[i].currency.name),
                      data: data.graphs[i].series[j].data
                    });
                  }
                } else {
                  bkOptions.series = [{
    ...
    function () {
      ...
      /*#__PURE__*/
      _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_7___default.a.mark(function _callee2(index, action) {
              ...
              case 0:
                ...
                graphs.forEach(function (element) {
                  bkGraphs.push({
                    ...
                    series: action === "save" ? element.chartOptions.series.length > 0 ? element.chartOptions.series[1] : element.chartOptions.series[0] : element.chartOptions.series[0],
    ...
    value: function render() {
      ...
      return __jsx(_components_layout__WEBPACK_IMPORTED_MODULE_17__["default"], {
        ...
        return __jsx("div", {
          ...
          __self: this
        }, "Save Current Data")), __jsx("button", {
...
//# sourceMappingURL=saveddata.js.8344ca132572872f59f8.hot-update.js.map