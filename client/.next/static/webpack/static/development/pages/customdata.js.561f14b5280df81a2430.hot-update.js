...
function (_Component) {
  ...
  function CustomData() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_15__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_13__["default"])(_this), "changeCryptocurrency", function (e) {
      console.log(e.target.value);

      _this.setState(Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_15__["default"])({}, "selected".concat(e.target.name), e.target.value));
    });

    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_15__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_13__["default"])(_this), "refreshAll", function () {
      ...
      var _loop = function _loop(i) {
        ...
        myWorker[i].onmessage = function (e) {
          bkOptions.series = [{
            type: "area",
            name: _this.state.graphs[i - 1].chartOptions.series[0].name,
            data: e.data
          }];
          console.log(graphs);
        ...
        myWorker[i].postMessage("".concat(_this.state.selectedCryptocurrency, ",").concat(_this.state.selectedCurrency, ",").concat(_this.state.jwt));
      };
    ...
    value: function render() {
      ...
      return __jsx(_components_layout__WEBPACK_IMPORTED_MODULE_17__["default"], {
        ...
        return __jsx("div", {
          ...
          __self: this
        }, __jsx(highcharts_react_official__WEBPACK_IMPORTED_MODULE_19___default.a, {
          key: item.id,
...
//# sourceMappingURL=customdata.js.561f14b5280df81a2430.hot-update.js.map