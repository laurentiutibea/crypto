...
/* harmony import */ var immutability_helper__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! immutability-helper */ "./node_modules/immutability-helper/index.js");
/* harmony import */ var immutability_helper__WEBPACK_IMPORTED_MODULE_19___default = /*#__PURE__*/__webpack_require__.n(immutability_helper__WEBPACK_IMPORTED_MODULE_19__);
  ...
  function CustomData() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_16__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_14__["default"])(_this), "liveData", function (index) {
      ...
      worker.onmessage = function (e) {
        ...
        _this.setState({
          graphs: immutability_helper__WEBPACK_IMPORTED_MODULE_19___default()(_this.state.graphs, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_16__["default"])({}, index, {
            $set: graphs[index]
          }))
        });
      };
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                console.log(graph);
                _context.next = 5;
                return _services_cryptoService__WEBPACK_IMPORTED_MODULE_21__["default"].saveGraph(graph).then(function (res) {
                  console.log("SUCCESS!");
                })["catch"](function (err) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 5;
                return _services_cryptoService__WEBPACK_IMPORTED_MODULE_21__["default"].getCryptocurrencies().then(function (res) {
    ...
    value: function render() {
      ...
      return __jsx(_components_layout__WEBPACK_IMPORTED_MODULE_18__["default"], {
        ...
        return __jsx("div", {
          ...
          __self: this
        }, !_this3.state.loading ? __jsx(Chart, {
          key: item.id,
...
//# sourceMappingURL=customdata.js.660e038dfe49bb64705c.hot-update.js.map