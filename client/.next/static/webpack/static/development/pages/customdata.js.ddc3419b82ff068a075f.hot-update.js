        ...
        return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_6___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                console.log(highcharts__WEBPACK_IMPORTED_MODULE_18___default.a.Color(highcharts__WEBPACK_IMPORTED_MODULE_18___default.a.getOptions().colors[0]));
                chartOptions = {
                  chart: {
                    zoomType: 'x'
                  },
                  ...
                  plotOptions: {
                    area: {
                      fillColor: {
                        ...
                        stops: [[0, "#7cb5ec"], [1, highcharts__WEBPACK_IMPORTED_MODULE_18___default.a.Color(highcharts__WEBPACK_IMPORTED_MODULE_18___default.a.getOptions().colors[0]).setOpacity(0).get('rgba')]]
                      },
                      marker: {
                        radius: 2
                      },
...
//# sourceMappingURL=customdata.js.ddc3419b82ff068a075f.hot-update.js.map