...
function (_Component) {
  ...
  function Index() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "handleReq", function () {// fetch("http://localhost:3900/api/crypto").then(res => res.json()).then(res => console.log("RESULT::: ", res));

      /* const socket = io("http://localhost:3900/api/crypto");
      socket.on("now", data => {
...
//# sourceMappingURL=index.js.a022f7b7a9fd603b71ee.hot-update.js.map