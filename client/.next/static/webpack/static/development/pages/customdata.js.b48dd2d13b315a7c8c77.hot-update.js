  ...
  function CustomData() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_16__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_14__["default"])(_this), "getFilteredCryptoCurrencies", function () {
      var _this$state = _this.state,
          searchQueryCryptocurrency = _this$state.searchQueryCryptocurrency,
          allData = _this$state.cryptocurrencies;
      var data = allData;
      if (searchQueryCryptocurrency) data = allData.filter(function (m) {
        return m.name.toLowerCase().startsWith(searchQueryCryptocurrency.toLowerCase());
      });
      return {
        data: data
      };
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_16__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_14__["default"])(_this), "getFilteredCurrencies", function () {
      var _this$state2 = _this.state,
          searchQueryCurrency = _this$state2.searchQueryCurrency,
          allData = _this$state2.currencies;
      var data = allData;
      if (searchQueryCurrency) data = allData.filter(function (m) {
        return m.name.toLowerCase().startsWith(searchQueryCurrency.toLowerCase());
      });
      return {
        data: data
      };
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_11__["default"])(CustomData, [{
    ...
    value: function render() {
      ...
      var _this$getFilteredCryp = this.getFilteredCryptoCurrencies(),
          cryptocurrencies = _this$getFilteredCryp.data;

      var _this$getFilteredCurr = this.getFilteredCurrencies(),
          currencies = _this$getFilteredCurr.data;
      ...
      return __jsx(_components_layout__WEBPACK_IMPORTED_MODULE_18__["default"], {
        ...
        __self: this
      }, "Hello ", this.state.user.name), __jsx("input", {
        type: "text",
        onChange: function onChange(e) {
          return _this3.handleSearch(e);
        },
        value: this.state.searchQueryCryptocurrency,
        name: "searchQueryCryptocurrency",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 268
        },
        ...
        value: this.state.searchQueryCurrency,
        name: "searchQueryCurrency",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 269
        },
        __self: this
      }), cryptocurrencies.length > 0 && __jsx("div", {
        ...
        __self: this
      }, cryptocurrencies.map(function (item) {
        return __jsx("option", {
          value: item.id,
          key: item.id,
          __source: {
...
//# sourceMappingURL=customdata.js.b48dd2d13b315a7c8c77.hot-update.js.map