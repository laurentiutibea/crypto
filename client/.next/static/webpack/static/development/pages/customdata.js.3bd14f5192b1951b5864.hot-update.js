  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Chart, [{
    ...
    value: function render() {
      ...
      return __jsx("div", {
        ...
        __self: this
      }, this.state.data.cryptocurrencies.length > 0 ? __jsx("div", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 56
        },
        __self: this
      }, console.log("HERE"), __jsx("div", {
        className: "col-md-3",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 58
        ...
        onChange: function onChange(e) {
          return _this2.changeGraphCryptocurrency(e, _this2.state.data.index);
        },
        defaultValue: this.state.data.item.cryptocurrency,
        ...
        __self: this
      }, this.state.data.cryptocurrencies.map(function (i) {
        return __jsx("option", {
          value: i.id,
          key: i.id,
          __source: {
        ...
        defaultValue: this.state.data.item.currency,
        className: "form-control",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 63
        ...
        __self: this
      }, this.state.data.currencies.map(function (i) {
        return __jsx("option", {
          value: i.id,
          key: i.id,
          __source: {
        ...
        type: "checkbox",
        onChange: function onChange(e) {
          return _this2.changeGraphLive(e, _this2.state.data.index);
        },
        defaultValue: this.state.data.item.live,
        className: "form-control",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 66
        ...
        onClick: function onClick() {
          return _this2.refreshSingle(_this2.state.data.index);
        },
        __source: {
          fileName: _jsxFileName,
          lineNumber: 67
        ...
        onClick: function onClick() {
          return _this2.removeGraph(_this2.state.data.index);
        },
        __source: {
          fileName: _jsxFileName,
          lineNumber: 69
        ...
        onClick: function onClick() {
          return _this2.saveGraph(_this2.state.data.index);
        },
        __source: {
          fileName: _jsxFileName,
          lineNumber: 70
        ...
        __self: this
      }, !this.state.data.loading ? __jsx(react_highcharts__WEBPACK_IMPORTED_MODULE_8___default.a, {
        key: this.state.data.item.id,
        highcharts: highcharts__WEBPACK_IMPORTED_MODULE_9___default.a,
        config: this.state.data.item.chartOptions,
        ref: "chart",
        oneToOne: true,
        __source: {
          fileName: _jsxFileName,
...
//# sourceMappingURL=customdata.js.3bd14f5192b1951b5864.hot-update.js.map