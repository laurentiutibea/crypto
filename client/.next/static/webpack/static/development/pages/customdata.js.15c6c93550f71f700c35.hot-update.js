...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_11__["default"])(CustomData, [{
    ...
    value: function render() {
      ...
      var currencies = this.getPageData(this.state.currencies);
      return __jsx(_components_layout__WEBPACK_IMPORTED_MODULE_18__["default"], {
        ...
        __self: this
      }, cryptocurrencies.length > 0 && cryptocurrencies.map(function (item) {
        return __jsx("option", {
          value: item.id,
          key: item.id,
          __source: {
        ...
        __self: this
      }, cryptocurrencies.length > 0 && currencies.map(function (item) {
        return __jsx("option", {
          value: item.id,
          key: item.id,
          __source: {
...
//# sourceMappingURL=customdata.js.15c6c93550f71f700c35.hot-update.js.map